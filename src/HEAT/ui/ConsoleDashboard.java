...
public class ConsoleDashboard {
    ...
    public void displayMenu() {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1: captureWorkoutInput(); break;
                case 2: captureGoalInput(); break;
                case 3: showGoalsMenu(); break;
                case 4: showQuote(); break;
                case 5: showBodyMetricHistory(); break;
                case 6: showWeeklySummary(); break;
                case 7: showPersonalRecords(); break;
                case 8: showAllWorkouts(); break;
                case 9: updateWeight(); break;
                case 10: updateBodyMetrics(); break;
                case 11: showUserProfile(); break;
                case 0:
    ...
    // ============================================================
    // User Profile Management (Registration & Viewing)
    // ============================================================

    private void captureUserProfileInput() {
        String name = "";
    ...
    private void captureWorkoutInput() {
        ConsoleUtils.printBorder();
    ...
    private void showPersonalRecords() {
        boolean inSubMenu = true;
    ...
    private void showBodyMetricHistory() {
        boolean inSubMenu = true;
